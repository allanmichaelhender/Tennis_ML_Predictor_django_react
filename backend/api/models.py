...
class Predictions(models.Model):
    ...
    player1WinOdds=models.DecimalField(max_digits=20, decimal_places=2, default=0)
    player2WinOdds=models.DecimalField(max_digits=20, decimal_places=2, default=0)
